...
import {animationLayout,validAnimation,salonDate} from '../src/animations.js';
...
test('la journée du programme suit l’édition et son réglage',()=>{
 assert.equal(salonDate(2026),'2026-10-03');assert.equal(salonDate(2027),'2027-10-02');assert.equal(salonDate(2027,'2027-10-09'),'2027-10-09');assert.equal(salonDate(2027,'2026-10-03'),'2027-10-02');
});
